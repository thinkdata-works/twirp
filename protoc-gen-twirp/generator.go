...
func (t *twirp) generateFileHeader(file *descriptor.FileDescriptorProto) {
	...
	if t.filesHandled == 0 {
		...
		t.P("This code was generated with github.com/thinkdata-works/twirp/protoc-gen-twirp ", gen.Version, ".")
		t.P()
...
func (t *twirp) generateImports(file *descriptor.FileDescriptorProto) {
	...
	t.P(`import `, t.pkgs["twirp"], ` "github.com/thinkdata-works/twirp"`)
	t.P(`import `, t.pkgs["ctxsetters"], ` "github.com/thinkdata-works/twirp/ctxsetters"`)
	t.P()
